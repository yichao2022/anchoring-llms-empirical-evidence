...
\begin{enumerate}
    ...
    \item \textbf{Position bias check:} Alternatives A/B presentation order matches the original DCE questionnaire; no counterbalancing was performed because the empirical frontier is order-invariant.
\end{enumerate}
