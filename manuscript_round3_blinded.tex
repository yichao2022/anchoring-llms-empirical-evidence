...
Respondents were recruited through an online panel provider (quota sampling: age 18--65, stratified by gender and education to approximate Wuhan adult population distribution). Eligibility criteria: adult resident of Wuhan, no prior COVID-19 vaccination. The study was approved by the [Institution REDACTED] Institutional Review Board (Protocol \#XXXXX); all respondents provided electronic informed consent before participation. The full DCE questionnaire, recruitment protocol, and de-identified response data are available in the public repository.
