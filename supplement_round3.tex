...
All 1,027 respondents completed the same six choice tasks, each presenting two non-opt-out alternatives (A, B) and an opt-out alternative (C). The six unique administered tasks provide a complete factorial coverage of the DCE design space with 12 non-opt-out profiles per respondent. We hold out 20\% of respondents ($N = 205$, respondents 823--1027) and use their choices on the six canonical tasks for validation.
