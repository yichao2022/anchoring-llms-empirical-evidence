...
\midrule
Pure-DCE & 0.3307 & 78 & Refit 6-param conditional logit, multinomial softmax over $\{A,B,C\}$ restricted to $\{A,B\}$ chosen \\
Unconstrained LLM & 0.8521 & 78 & Direct LLM $P(A)$, $P(B)$, $P(C)$ with respondent-facing multinomial prompt, restricted to $\{A,B\}$ chosen \\
