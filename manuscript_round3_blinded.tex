...
\caption{Held-out-respondent validation multinomial log loss on the six administered DCE choice tasks (Pure-DCE: $0.911$; EFR: $0.923$; Raw LLM: $1.020$; uniform benchmark: $1.099$; $N=205$ held-out respondents, 1,230 choices). Because all respondents completed identical tasks, this validation evaluates generalization to unseen respondents rather than to unseen choice tasks or attribute profiles.}
