...
\begin{table}[h]
\centering
\caption{No full three-alternative task satisfied the canonical matching rule; therefore no apples-to-apples three-alternative task-level score is reported. The 78-task A-versus-B analysis in Table~\ref{tab:multinom_2alt} is the primary task-level validation.}
