...
\item \textbf{Table S7.} $\lambda$-sensitivity for held-out DCE predictive validation on the 813 \emph{alternative-level} rows subset (from 205 held-out respondents). Alt-level binary log loss, Brier score, and AUC across $\lambda$.
